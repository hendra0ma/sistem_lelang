                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="card card-outline card-primary">
                                            <div class="card-header text-center">
                                                <a href="http://localhost/sistemLelang/dashboard/admin/home/" class="h3"><b> Edit Profile</b></a>
                                            </div>
                                            <div class="card-body" style="display: block;">
                                                <form action="<?= base_url() ?>auth/admin/update/user" method="post" enctype='multipart/form-data'>
                                    ...
                                    <div class="col-md-6">
                                        <center>
                                            <?php if ($admin->gambar == "") : ?>
                                                <img src="<?= base_url() ?>public/assets/dashboard/docs/assets/img/image-default.png" alt="Image Admin" class="img-fluid image" style="height:350px !important;border-radius:10px;">
                                            <?php else : ?>
                                                <img src="<?= base_url() ?>public/assets/dashboard/docs/assets/img/upload/<?= $admin->gambar ?>" alt="Image Admin" class="img-fluid image" style="height:350px !important;border-radius:10px;">
                                            <?php endif; ?>
                                        </center>
                        ...
                        <div class="card bg-gradient-danger" style="position: relative; left: 0px; top: 0px;">
                            ...
                            <div class="card-body">
                                <div class="col-md-12">
                                    <div class="card card-outline card-primary">
                                        <div class="card-header text-center">
                                            <a href="http://localhost/sistemLelang/dashboard/admin/home/" class="h3"><b>Ganti Password</b></a>
                                        </div>
                                        <div class="card-body" style="display: block;">

                                            <form action="<?= base_url() ?>auth/admin/update/password" method="post">
                                                <input type="hidden" name="id" value="<?= $_SESSION['id'] ?>">
                                                <div class="input-group mb-3">
